        ...
        <div className="mt-8 space-y-4 lg:mt-0">
          ...
          <form className="mt-6 w-full">
            ...
            >
              ...
              <button
                className="mt-1 w-full rounded bg-black px-6 py-3 text-sm font-bold uppercase tracking-wide text-white transition-none hover:bg-teal-600 sm:mt-0 sm:w-auto sm:shrink-0"
              >
                Sign Up
              </button>
            </div>
